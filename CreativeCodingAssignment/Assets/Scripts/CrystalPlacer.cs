...
public class CrystalPlacer : MonoBehaviour
{
    ...
    public float TreeMinHeight = 295;

    [Header("Debug")]
    public int DebugSpawnCount = 10;
    ...
    public void Spawn(int count)
    {
        ...
        for (var i = 0; i < count; i++) {
            ...
            if (hit.point.y < TreeMinHeight) continue;

            Debug.LogWarning("Tree At: " + hit.point);
    ...
    public void PlaceGrassAt(Transform parent, Vector3 position, float radius)
    {
        ...
        for (var i = 0; i < count; i++) {
            ...
            newObj.transform.position = hit.point + Vector3.up * 1.5f;
